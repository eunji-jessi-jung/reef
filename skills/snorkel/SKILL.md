...
**Refresh CLAUDE.md** at the reef root. Update artifact counts, CON- artifact list, SYS- artifact list, and freshness date. Use the template in `${CLAUDE_PLUGIN_ROOT}/references/claude-md-template.md`. This keeps the reef discoverable by AI agents as it grows.
